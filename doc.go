...
The Client example below shows how to use this package to connect
to a Microsoft Azure Service Bus queue.

The Server example shows an AMQP server that can accept incoming sessions and
links and stores messages on a single queue.
*/
